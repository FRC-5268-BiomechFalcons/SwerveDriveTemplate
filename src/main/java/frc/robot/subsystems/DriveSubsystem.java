...
public class DriveSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        ...
        odometry.update(Rotation2d.fromDegrees(gyro.getAngle(IMUAxis.kZ)),
                new SwerveModulePosition[] { frontLeft.getPosition(), frontRight.getPosition(),
                        rearLeft.getPosition(), rearRight.getPosition() });
        ...
        if (poseFrames.length > 0) {
            ...
            odometry.resetPose(robotPose.toPose2d());
        } else {
    ...
    private void limelightPoseTracking(String limelight) {
        ...
        if (!doRejectUpdate) {
            ...
            odometry.addVisionMeasurement(pose, timestamp, limelightStdDevs);
        }
    ...
    public void resetOdometry(Pose2d pose) {
        odometry.resetPosition(Rotation2d.fromDegrees(gyro.getAngle(IMUAxis.kZ)),
                new SwerveModulePosition[] { frontLeft.getPosition(), frontRight.getPosition(),
                        rearLeft.getPosition(), rearRight.getPosition() },
                pose);
